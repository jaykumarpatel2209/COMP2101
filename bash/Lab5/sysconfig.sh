...
function error-message {
	echo "Due to interrupt, execution can't be completed";
}
...
function error-exit {
	echo "Command not found, please type valid command"; 
	exit 1;
}
...
function displayhelp {
	cat << EOF
  	...
  	$0 [-h |--help]	-> It will provide various option and it's usages to user.
  	$0 [--host]		-> It will provide host name
  	$0 [--domain]		-> It will provide domain name
  	$0 [--ipconfig] 	-> It will provide various IP information
  	$0 [--os]		-> It will provide Opearting system information
  	$0 [--cpu]		-> It will provide CPU information
  	$0 [--memory]		-> It will provide memory information
  	$0 [--disk]		-> It will provide disk information
  	$0 [--printer]		-> It will provide printer information
EOF
}
